...
| key | 카피 | 용도 |
|---|---|---|
| `market.preOpen` | `장전` | 장전 상태 라벨 |
| `market.open` | `장중` | 장중 상태 라벨 |
| `market.closed` | `장마감` | 장마감 상태 라벨 |
| `header.updated` | `{time} 기준` | 갱신 시각 (e.g. "14:32:05 기준") |
| `header.closingRef` | `종가 기준` | 장마감 시 헤더 |
